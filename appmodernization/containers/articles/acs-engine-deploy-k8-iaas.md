...
* Install the kubectl binary via curl. Follow the Linux tab on instructions [here](https://kubernetes.io/docs/tasks/tools/install-kubectl/#install-kubectl-binary-via-curl). 
...
6. Connect to the Kubernetes cluster:
   ...
   2. View your Kubernetes configuration. The following command will output your Kubernetes endpoints that you will use to connect to.
