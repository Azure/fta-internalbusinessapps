...
INSERT INTO dbo.Expense (Purpose, ExpenseDate, Amount, EmployeeName, EmployeeEmail, ApproverName, ApproverEmail, Receipt)  values ('FastTrack team visit-3', '2017-5-12', 1200, 'Randy', 'u@example.org', 'Anusha', 'a@example.org', 'http://contosocandies-cdnep.azureedge.net/cdn/candie-3.jpg')
